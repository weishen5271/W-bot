---
name: pdf-reader
description: Read PDFs, extract text, answer questions, and produce summaries directly in chat without creating output files unless the user asks.
...
Use this skill when the user wants to read, inspect, search, quote, explain, or summarize a PDF.
Default behavior: return the extracted content or summary directly in the conversation.
Do not create local output files unless the user explicitly asks to export or save the result.
...
**Output:** Plain text content from the PDF, intended to be quoted, summarized, or answered from directly in chat.
